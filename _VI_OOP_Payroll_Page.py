...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def saveData():  # For Save Button
        employee_number = Employee_Number.get()
        cursor.execute("SELECT Employee_Number FROM main_employee_information_tbl WHERE Employee_Number = ?",
                       (employee_number,))
        cursor.execute("SELECT Employee_Number FROM I_employee_personal_information_tbl WHERE Employee_Number=?",
                       (employee_number,))
